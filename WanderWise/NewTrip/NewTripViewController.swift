        ...
        for day in daysString {
            ...
            for event in eventsString {
                ...
                if values.count == 5 {
                    ...
                    print(String(values[3].dropFirst().dropLast().dropFirst()))
                    print(String(values[4].dropFirst().dropLast().dropFirst()))
